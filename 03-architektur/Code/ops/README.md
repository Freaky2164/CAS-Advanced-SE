...
| `backup-interim.ps1` | **Uebergangs-Backupjob bis pgBackRest laeuft:** verschluesselter `pg_dump` (AES256/GPG) auf ein getrenntes Volume, mit Vorpruefungen, SHA-256-Nachweis, Logdatei und Aufbewahrungsregel. Zeitsteuerung ueber die Windows-Aufgabenplanung. Kein Point-in-Time Recovery. |
