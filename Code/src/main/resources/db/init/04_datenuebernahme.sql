...
-- frauenhaus.* (01_schema.sql = V1__baseline_schema.sql) und räumt anschließend alle
-- Alt-Tabellen wieder weg.
--
...
-- Import-Rolle entfernen (idempotent: das Skript soll auch manuell nachfahrbar sein)
DROP ROLE IF EXISTS rebasedata;
