...
/**
 * @author Nils
 *     <p>Testet {@link BetragInWorten#von(BigDecimal)} für ganze Beträge, Centbeträge und den
 *     Nullfall.
 */
class BetragInWortenTest {
  ...
  void ganzeBetraege() {
    ...
    assertEquals(
        "*eintausendzweihundertvierunddreißig Euro*", BetragInWorten.von(new BigDecimal("1234")));
