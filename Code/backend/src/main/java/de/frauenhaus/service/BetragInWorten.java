...
/**
 * @author Nils
 *     <p>Betrag in Worten für Spendenquittungen (Pflichtangabe), Port von
 *     CCommandSpendenQuittung.betragInWorten.
 */
public final class BetragInWorten {
  ...
  /**
   * @author Nils
   *     <p>Zahlwort ohne Währungsangabe – für Vorlagen, die das Wort "Euro" bereits enthalten
   *     (Lesezeichen {@code worte} in den Spendenbescheinigungen), z.B. {@code 50.05} -> {@code
   *     "*fünfzig Komma null fünf*"}.
   */
  ...
  /**
   * @author Nils
   *     <p>Wandelt einen Geldbetrag in die für Spendenquittungen übliche Textform um, z.B. {@code
   *     50.05} -> {@code "*fünfzig Euro und fünf Cent*"}.
   */
  ...
  /**
   * @author Nils
   *     <p>Wandelt eine nichtnegative Ganzzahl rekursiv in deutsche Zahlwörter um.
   */
  ...
  /**
   * @author Nils
   *     <p>Standalone "eins" wird als Multiplikator zu "ein" (eintausend, einhunderteintausend).
   */
  private static String alsPrefix(String zahlwort) {
    return zahlwort.endsWith("eins") ? zahlwort.substring(0, zahlwort.length() - 1) : zahlwort;
  }
}
