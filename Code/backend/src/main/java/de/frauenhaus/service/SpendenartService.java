...
/**
 * @author Nils
 *     <p>Pflege der Spendenarten (alt: generisches CInfoFrame auf frauenhaus.spendenart).
 */
@Service
@Transactional
public class SpendenartService {
  ...
  public Spendenart finden(String name) {
    return spendenarten
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(NOT_FOUND, "Spendenart '" + name + "' nicht gefunden"));
  }
  ...
  public void loeschen(String name) {
    ...
    try {
      ...
      throw new ResponseStatusException(
          CONFLICT, "Spendenart '" + name + "' wird noch von Spenden verwendet");
    }
  }
