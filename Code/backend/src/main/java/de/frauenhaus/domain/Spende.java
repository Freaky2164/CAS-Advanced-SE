...
/**
 * @author Nils
 *     <p>Spende eines {@link Mitglied}s an einen {@link Verein}, klassifiziert nach {@link
 *     Spendenart} (alt: frauenhaus.spende).
 */
@Entity
...
public class Spende {
  ...
  public Spendenart getSpendenart() {
    return spendenart;
  }

  public void setSpendenart(Spendenart spendenart) {
