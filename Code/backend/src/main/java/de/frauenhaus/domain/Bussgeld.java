...
/**
 * @author Nils
 *     <p>Bußgeld-Zuweisung durch ein {@link Gericht} an einen {@link Verein} (alt:
 *     frauenhaus.bussgeld). Hält den geschuldeten Betrag sowie alle zugehörigen {@link Eingang
 *     Zahlungseingänge}.
 */
@Entity
...
public class Bussgeld {
  ...
  public void setZieldatum(LocalDate zieldatum) {
  ...
  public List<Eingang> getEingaenge() {
    return eingaenge;
  }
}
