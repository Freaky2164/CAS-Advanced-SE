...
/**
 * @author Nils
 *     <p>Spendentyp-Lookup für {@link Spendenart} (alt: frauenhaus.spendentyp), z.B. 'Geldspende
 *     dauer', 'Mitgliedsbeitrag', 'Dauerspende', 'Sachspende'. Bisher nur als
 *     DB-Fremdschlüssel-Constraint vorhanden, jetzt als eigenständige Stammdaten-Entität für die
 *     Pflege der zulässigen Spendentypen (Grundlage für Stammdaten-CRUD).
 */
@Entity
