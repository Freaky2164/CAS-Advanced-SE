...
/**
 * @author Nils
 *     <p>REST-Endpunkte zur Pflege der Träger (Verein-Stammdaten).
 */
@RestController
...
public class VereinController {
  ...
  @PutMapping("/{name}")
  public Verein bezeichnungAendern(
      @PathVariable String name, @Valid @RequestBody BezeichnungRequest request) {
