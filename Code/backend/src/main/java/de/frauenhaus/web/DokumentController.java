...
/**
 * @author Nils
 *     <p>REST-Endpunkte für Dokument-Anhänge zu den auditierbaren Stammdaten.
 */
@RestController
...
public class DokumentController {
  ...
  public ResponseEntity<DokumentMetadaten> hochladen(
  ...
  public List<DokumentMetadaten> liste(
      @PathVariable String entityTyp, @PathVariable String entityId) {
