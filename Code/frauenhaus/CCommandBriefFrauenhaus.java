...
public class CCommandBriefFrauenhaus extends CCommand implements CReport {

    private static final Logger LOGGER = Logger.getLogger(CCommandBriefFrauenhaus.class.getName());
    private final String vorlagen;
    String wert = "";
    private String mitglied = "";

    public CCommandBriefFrauenhaus() {
    ...
    public void go() {
        String sqlString = "SELECT anrede, vorname, name, name2, name3, strasse, plz, ort, briefanrede "
                ...
                + "WHERE mitglied = ?";
        try {
            File file = new File(vorlagen + "/FHBrief.dot");
            ...
            LOGGER.log(Level.SEVERE, "Failed to generate Frauenhaus letter", e);
        }
    }
