...
*/
	...
	protected void buttonAction(ActionEvent e) {
	    Object o = CPropertyManager.getInstance().getDialog(e.getActionCommand().toString() + ".list");
	    if (o == null) {
